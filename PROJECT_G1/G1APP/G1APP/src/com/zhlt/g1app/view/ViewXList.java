...
public class ViewXList extends ListView implements OnScrollListener {
	...
	// -- header view
	private ViewXListHeader mHeaderView;
	...
	// -- footer view
	private ViewXListFooter mFooterView;
	...
	private AdpCommunityListView mCommunityAdapter;
	 ...
	 * @param context
	 */
	public ViewXList(Context context) {
		super(context);
		initWithContext(context);
	}

	public ViewXList(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
		initGirdView(attrs);
	}

	public ViewXList(Context context, AttributeSet attrs, int defStyle) {
	...
	private void initWithContext(Context context) {
		...
		// init header view
		mHeaderView = new ViewXListHeader(context);
		...
		// init footer view
		mFooterView = new ViewXListFooter(context);
	...
	private void initGirdView(AttributeSet attrs) {
		TypedArray array = getContext().obtainStyledAttributes(attrs,
				R.styleable.gridview);
		numColumns = array.getInteger(R.styleable.gridview_numColumns, 0);
		horizontalSpacing = array.getDimensionPixelSize(
				R.styleable.gridview_horizontalSpacing, 0);
		Log.d("zzw", "initGirdView:" + numColumns + " " + horizontalSpacing);
	}
	/** 该函数确定图片存放在View里面的范围 */
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (numColumns != 0) {
			columnsWidth = (getMeasuredWidth()
					- getPaddingLeft()
					- getPaddingRight()
					- 2
					* getResources()
							.getDimensionPixelOffset(R.dimen.marginleft)
					- 2
					* getResources().getDimensionPixelOffset(
							R.dimen.item_border)
					- 2
					* getResources()
							.getDimensionPixelOffset(R.dimen.head_width) - numColumns
					* 2 * horizontalSpacing)
					/ numColumns;
			Log.d("zzw", "onMeasure:" + columnsWidth);
			if (mCommunityAdapter != null) {
				((AdpCommunityListView) mCommunityAdapter)
