...
public final class ViewTableManger extends View implements SensorEventListener {
	// 设定标志位
	private static final String TAG = ViewTableManger.class.getSimpleName();
	//
	...
	public ViewTableManger(Context context) {
		super(context);
		init();

	}

	public ViewTableManger(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}

	public ViewTableManger(Context context, AttributeSet attrs, int defstyle) {
	...
	private void initDrawingTools() {
		...
		faceTexture = BitmapFactory.decodeResource(getContext().getResources(), 
				   R.drawable.wifi_index_background);
		...
		paperMatrix.setScale(4.0f / faceTexture.getWidth(), 
				//====
							 4.0f / faceTexture.getHeight());
		...
		logo = BitmapFactory.decodeResource(getContext().getResources(),R.drawable.act_flow_index);
		logoMatrix = new Matrix();
		//logoScale = (1.0f / logo.getWidth()) * 0.3f;;
		//更改指针长度&宽度
		logoScale=(1.0f/logo.getWidth())*0.6f;
	...
	private void regenerateBackground() {
		...
		background = Bitmap.createBitmap(getWidth(), getHeight()/2, Bitmap.Config.ARGB_8888);
