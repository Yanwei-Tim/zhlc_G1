...
public class SideBar extends View {
	...
	private AdpCarModelListView sectionIndexter = null;
	...
	private int textSize = 30;// bar上的文字的字体大小
	private Paint paint;
...
//					mDialogText.setVisibility(View.GONE);
	...
	public void setListView(ListView _list) {
		list = _list;
		sectionIndexter = (AdpCarModelListView) _list.getAdapter();
	}
...
//			mDialogText.setText("" + l[idx]);// 设置提示内容
			if (sectionIndexter == null) {
				sectionIndexter = (AdpCarModelListView) list.getAdapter();
			}
