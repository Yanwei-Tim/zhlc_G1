...
public class UpdateManager {
	...
	private Handler mHandler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case DOWNLOAD:
				// 设置进度条位置
//zzw		mProgress.setProgress(progress);
//				mProgress_tv.setText(progress + "%");
	...
	private boolean isUpdate() {
		...
		try {
			URL url = new URL("http://120.24.91.146:8080/apk/version.xml");
			// 创建连接
	...
	private void showNoticeDialog(String msg) {
		...
		// noticeDialog.show();
		dialogView = new DialogView((Activity) mContext);
		dialogView
				.setTitle(mContext.getResources().getString(R.string.upgrade));
		dialogView.setLeft(mContext.getResources().getString(
				R.string.upgrade_latter));
		dialogView.setRight(mContext.getResources().getString(
				R.string.upgrade_now));
		dialogView.setOnClickListener(mOnClickListener);
	...
	private void downloadApk() {
		...
		Toast.makeText(mContext, "下载中", 0).show();
	}
