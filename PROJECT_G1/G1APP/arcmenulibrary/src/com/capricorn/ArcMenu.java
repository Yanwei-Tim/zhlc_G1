...
//                	Log.e("LUOYINTEST", "点击展开="+mArcLayout.isExpanded());
                    mHintView.startAnimation(createHintSwitchAnimation(mArcLayout.isExpanded()));
//                    Log.e("LUOYINTEST", "点击2="+mArcLayout.isExpanded());
                    mArcLayout.startAnimations(true);
//                    Log.e("LUOYINTEST", "点击3="+mArcLayout.isExpanded());
                }
