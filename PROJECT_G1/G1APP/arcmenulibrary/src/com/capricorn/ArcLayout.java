...
//        Log.w("LUOYINTEST", "onMeasure-size="+size);
...
//        Log.w("LUOYINTEST", "onLayout-radius="+radius);
...
//    	Log.e("LUOYINTEST", "Expand-toXDelta="+toXDelta);
...
//        Log.e("LUOYINTEST", "Shrink-toXDelta="+toXDelta);
    ...
    private void bindChildAnimation(final View child, final int index, final long duration) {
        ...
        final int childCount = getChildCount();
//        Log.e("LUOYINTEST", "centerX="+centerX);
//        Log.e("LUOYINTEST", "centerY="+centerY);
//        Log.e("LUOYINTEST", "radius="+radius);
        final float perDegrees = (mToDegrees - mFromDegrees) / (childCount - 1);
        Rect frame = computeChildFrame(centerX, centerY, radius, mFromDegrees + index * perDegrees, mChildSize);

        final int toXDelta = frame.left - child.getLeft();
        final int toYDelta = frame.top - child.getTop();
//        Log.e("LUOYINTEST", "toXDelta="+toXDelta);
//        Log.e("LUOYINTEST", "toYDelta="+toYDelta);
//        Log.e("LUOYINTEST", "mExpanded="+mExpanded);
        Interpolator interpolator = mExpanded ? new AccelerateInterpolator() : new OvershootInterpolator(1.5f);
        final long startOffset = computeStartOffset(childCount, mExpanded, index, 0.1f, duration, interpolator);
//        Log.e("LUOYINTEST", "startOffset="+startOffset);
    ...
    public void startAnimations(final boolean showAnimation){
    	if (showAnimation) {
            final int childCount = getChildCount();
            for (int i = 0; i < childCount; i++) {
                bindChildAnimation(getChildAt(i), i, 1000);
            }
        }
    	if (!showAnimation) {
            requestLayout();
...
//        }
        ...
        mExpanded = !mExpanded;
        Log.e("LUOYINTEST", "问题点333showAnimation="+showAnimation);
        //就是这个判断影响了动画效果
        if (!showAnimation) {
            requestLayout();
        }
