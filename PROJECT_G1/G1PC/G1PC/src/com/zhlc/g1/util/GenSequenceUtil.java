...
//		System.out.println("time1-time2=="+randomNO);
    ...
    public static String getFullDateRandomNum(int randomBit) {
        ...
        if (randomBit == 0) {
            ...
            //根据随机位数，设置返回字符串
            if (randomBit == 1) {
                return uuid + String.valueOf(Long.parseLong(datedfStr) * 10 + numCount);
            } else if (randomBit == 2) {
                return uuid + String.valueOf(Long.parseLong(datedfStr) * 100 + numCount);
            } else if (randomBit == 3) {
                return uuid + String.valueOf(Long.parseLong(datedfStr) * 1000 + numCount);
            } else if (randomBit == 4) {
                return uuid + String.valueOf(Long.parseLong(datedfStr) * 10000 + numCount);
            }
    ...
    public static void main(String args[]) {
        try {
            ...
            System.out.println(GenSequenceUtil.getFullDateRandomNum(0));
            System.out.println(GenSequenceUtil.getFullDateRandomNum(0).length());
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
